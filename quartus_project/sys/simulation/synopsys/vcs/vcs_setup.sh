...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_2_rsp_mux_001.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_2_rsp_mux.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_2_rsp_demux_013.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_2_rsp_demux.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_2_cmd_mux_013.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_2_cmd_mux.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_2_cmd_demux_001.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_2_cmd_demux.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_2_router_016.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_2_router_015.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_2_router_002.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_2_router_001.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_2_router.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_0_avalon_st_adapter.v \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_0_rsp_mux.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_0_rsp_demux.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_0_cmd_mux.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_0_cmd_demux.sv \
  ...
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_0_router_001.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_0_router.sv \
  ...
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_2.v \
  ...
  $QSYS_SIMDIR/submodules/altera_avalon_mailbox.v \
  ...
  $QSYS_SIMDIR/submodules/sys_i2c_shared_buffer.v \
