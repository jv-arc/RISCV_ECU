...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_1_rsp_demux_010.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_1_rsp_demux.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_1_cmd_mux_010.sv \
  ...
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_1_router_013.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_1_router_012.sv \
  ...
  $QSYS_SIMDIR/submodules/sys_GPIO_A_DIR.v \
  $QSYS_SIMDIR/sys.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
