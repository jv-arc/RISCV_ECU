...
module sys_mm_interconnect_1 (
	...
	wire    [5:0] cmd_mux_001_src_channel;                                                             // cmd_mux_001:src_channel -> pio_out_s1_agent:cp_channel
	...
	wire    [5:0] cmd_mux_002_src_channel;                                                             // cmd_mux_002:src_channel -> pio_in_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_004_src_data;                                                                // cmd_mux_004:src_data -> onchip_memory2_0_s2_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                               // onchip_memory2_0_s2_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                                             // cmd_mux_004:src_channel -> onchip_memory2_0_s2_agent:cp_channel
	...
	wire          cmd_mux_005_src_valid;                                                               // cmd_mux_005:src_valid -> pulpino_0_avalon_slave_debug_agent:cp_valid
	wire  [105:0] cmd_mux_005_src_data;                                                                // cmd_mux_005:src_data -> pulpino_0_avalon_slave_debug_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                               // pulpino_0_avalon_slave_debug_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                             // cmd_mux_005:src_channel -> pulpino_0_avalon_slave_debug_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                                       // cmd_mux_005:src_startofpacket -> pulpino_0_avalon_slave_debug_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                         // cmd_mux_005:src_endofpacket -> pulpino_0_avalon_slave_debug_agent:cp_endofpacket
	...
	wire  [105:0] timer_0_s1_agent_rp_data;                                                            // timer_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [105:0] onchip_memory2_0_s2_agent_rp_data;                                                   // onchip_memory2_0_s2_agent:rp_data -> router_006:sink_data
	...
	wire          pulpino_0_avalon_slave_debug_agent_rp_valid;                                         // pulpino_0_avalon_slave_debug_agent:rp_valid -> router_007:sink_valid
	wire  [105:0] pulpino_0_avalon_slave_debug_agent_rp_data;                                          // pulpino_0_avalon_slave_debug_agent:rp_data -> router_007:sink_data
	wire          pulpino_0_avalon_slave_debug_agent_rp_ready;                                         // router_007:sink_ready -> pulpino_0_avalon_slave_debug_agent:rp_ready
	wire          pulpino_0_avalon_slave_debug_agent_rp_startofpacket;                                 // pulpino_0_avalon_slave_debug_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          pulpino_0_avalon_slave_debug_agent_rp_endofpacket;                                   // pulpino_0_avalon_slave_debug_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire    [5:0] router_src_channel;                                                                  // router:src_channel -> pulpino_0_avalon_master_lsu_limiter:cmd_sink_channel
	...
	wire    [5:0] pulpino_0_avalon_master_lsu_limiter_cmd_src_channel;                                 // pulpino_0_avalon_master_lsu_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire    [5:0] rsp_mux_src_channel;                                                                 // rsp_mux:src_channel -> pulpino_0_avalon_master_lsu_limiter:rsp_sink_channel
	...
	wire    [5:0] pulpino_0_avalon_master_lsu_limiter_rsp_src_channel;                                 // pulpino_0_avalon_master_lsu_limiter:rsp_src_channel -> pulpino_0_avalon_master_lsu_agent:rp_channel
	...
	wire    [5:0] router_001_src_channel;                                                              // router_001:src_channel -> master_0_master_limiter:cmd_sink_channel
	...
	wire    [5:0] master_0_master_limiter_cmd_src_channel;                                             // master_0_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire    [5:0] rsp_mux_001_src_channel;                                                             // rsp_mux_001:src_channel -> master_0_master_limiter:rsp_sink_channel
	...
	wire  [105:0] cmd_demux_001_src1_data;                                                             // cmd_demux_001:src1_data -> cmd_mux_005:sink0_data
	...
	wire  [105:0] rsp_demux_005_src0_data;                                                             // rsp_demux_005:src0_data -> rsp_mux_001:sink1_data
	...
	wire    [5:0] pulpino_0_avalon_master_lsu_limiter_cmd_valid_data;                                  // pulpino_0_avalon_master_lsu_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [5:0] master_0_master_limiter_cmd_valid_data;                                              // master_0_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire          pulpino_0_avalon_slave_debug_agent_rdata_fifo_src_valid;                             // pulpino_0_avalon_slave_debug_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] pulpino_0_avalon_slave_debug_agent_rdata_fifo_src_data;                              // pulpino_0_avalon_slave_debug_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          pulpino_0_avalon_slave_debug_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_005:in_0_ready -> pulpino_0_avalon_slave_debug_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                   // avalon_st_adapter_005:out_0_valid -> pulpino_0_avalon_slave_debug_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                                    // avalon_st_adapter_005:out_0_data -> pulpino_0_avalon_slave_debug_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                   // pulpino_0_avalon_slave_debug_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                   // avalon_st_adapter_005:out_0_error -> pulpino_0_avalon_slave_debug_agent:rdata_fifo_sink_error
	...
	sys_mm_interconnect_1_router_007 router_007 (
	...
	sys_mm_interconnect_1_cmd_mux_004 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (pulpino_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sys_mm_interconnect_1_rsp_demux_004 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (pulpino_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
